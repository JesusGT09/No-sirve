...
import com.bolsadeideas.springboot.backend.apirest.models.services.IUploadFileClienteService;
...
public class ClienteRestController {
	...
	@Autowired
	private IUploadFileClienteService uploadService;
	...
	public Page<Cliente> idnex(@PathVariable Integer page) {
	...
	@GetMapping("/uploads/img/cli/{nombreFoto:.+}")
